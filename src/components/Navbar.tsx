		...
		<div className="flex h-20 w-full items-center justify-between px-32 py-1 shadow-lg">
			...
			<div className="flex gap-x-10 text-2xl">
				{navbarLinks.map((link) => (
					<a className="duration-200 [text-shadow:_0px_2px_2px_rgb(0_0_0_/_40%)] hover:-translate-y-0.5 hover:cursor-pointer hover:[text-shadow:_0px_4px_4px_rgb(0_0_0_/_40%)]">
						{link.titleTR}
					</a>
				))}
			</div>
